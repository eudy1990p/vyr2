...
public class ProveedorAdministrar extends javax.swing.JFrame {
    ...
    public ProveedorAdministrar(Mysql conector,String usuarioID,String usuarioNombre) {
        initComponents();
       ...
       // JOptionPane.showMessageDialog(null, " "+this.jTableCliente.getColumnModel().getColumnCount());
    ...
    */
    ...
    public void insertarDBPersona(){        
        Log.Registrar(this.getClass(), "insertarDBPersona"," "); 
           ...
           String campos = "nombre,apellido,sexo,fecha_creado,usuario_id,rnc,cedula";//fecha_nacimiento
             String valores = "'"+this.nombre+"','"+this.apellido+"','"+this.sexo+"',now(),'"+this.usuarioID+"','"+this.rnc+"','"+this.cedula+"'";
             this.conector.insertData("persona", campos, valores);
             this.personaID = this.conector.optenerUltimoID("persona");
    }
    public void insertarDBProveedor(){        
        Log.Registrar(this.getClass(), "insertarDBProveedor"," "); 

           String campos = "usuario_id,persona_id,fecha_creado";//fecha_nacimiento
             String valores = "'"+this.usuarioID+"','"+this.personaID+"',now()";
             this.conector.insertData("proveedor", campos, valores);
             this.empleadoID = this.conector.optenerUltimoID("proveedor");
    }
    /*
 ...
 Log.Registrar(this.getClass(), "MostrarBotones"," "); 
   ...
   public void cargarTabla(){
        ...
        try {
         String table_name = "proveedor as c "
                + "inner join persona as p on c.persona_id = p.id "
                + "inner join usuario as u1 on p.usuario_id = u1.id ";
        ...
        resultSet.first();
        String[] titulos = {"ID","PROVEEDOR","CEDULA","RNC","SEXO","CREADO POR"};
