 ...
 * @author VOSTRO
 */
public class EmpleadoAdministrar extends javax.swing.JFrame {
    ...
    private EmpleadoAdministrar yo;
    ...
    public void setYo(EmpleadoAdministrar yo) {
Log.Registrar(this.getClass(), "setYo"," ");

        this.yo = yo;
    }
    
    public void setUsuarioID(String usuarioID) {
Log.Registrar(this.getClass(), "setUsuarioID"," ");

        this.usuarioID = usuarioID;
    }

    public void setUsuarioNombre(String usuarioNombre) {
Log.Registrar(this.getClass(), "setUsuarioNombre"," ");

        this.usuarioNombre = usuarioNombre;
    }

    public void setConector(Mysql conector) {
Log.Registrar(this.getClass(), "setConector"," ");
    ...
    public EmpleadoAdministrar(Mysql conector,String usuarioID,String usuarioNombre) {
        initComponents();
    ...
    */
    public void BuscadorCliente(){
        Log.Registrar(this.getClass(), "BuscadorCliente","Buscar empleado");
         this.Buscador = "";
        ...
        this.cargarTabla();
        Log.Registrar(this.getClass(), "BuscadorCliente"," "+this.Buscador);
        
    }
    
    public void agregarTipoTelefono(){
         Log.Registrar(this.getClass(), "agregarTipoTelefono"," mostrar");            
       ...
       public void MostrarTipoTelefono(){
        ...
        try {
            ...
            if( resultSet.first() ){
              ...
              Log.Registrar(this.getClass(), "MostrarTipoTelefono","se mostro");
...
Log.Registrar(this.getClass(), "validarUsuario"," ");
         ...
         int existe = this.conector.getValues("usuario", "where nombre_usuario = '"+this.usuario+"' ");
          if(existe < 1){
            return true;
        }else{
...
Log.Registrar(this.getClass(), "insertarDBUsuario"," ");
           String campos = "nombre_usuario,clave_usuario,tipo_usuario,usuario_id,fecha_creado";//fecha_nacimiento
             ...
             this.conector.insertData("usuario", campos, valores);
             this.usuarioEmpleadoID = this.conector.optenerUltimoID("usuario");
    }
 ...
 Log.Registrar(this.getClass(), "insertarDBDireccion"," ");  
   ...
   */
    public void insert(){
        Log.Registrar(this.getClass(), "insert","Insertar empleado");
       //valida si podemos continuar
        if(this.validarVacioContinuo()){
           ...
           try {
              ...
              Log.Registrar(this.getClass(), "insert","se inserto el empleado");
           } catch (Exception ex) {
               Log.Error(this.getClass().getName(), ex);
               Logger.getLogger(EmpleadoAdministrar.class.getName()).log(Level.SEVERE, null, ex);
           }
           }else{
...
Log.Registrar(this.getClass(), "validarVacioContinuo"," ");
 ...
 Log.Registrar(this.getClass(), "limpiar"," ");
        ...
        Log.Registrar(this.getClass(), "limpiar","Se limpiearon los campos");
    }
    public void eliminar(){
       ...
       int index = this.jTableCliente.getSelectedRow();
        if(index >= 0){
           if(JOptionPane.showConfirmDialog(null, "Esta seguro que desea eliminar el empleado?", "Eliminar empleado", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION ){ 
  ...
  public void MostrarDato(){
      Log.Registrar(this.getClass(), "MostrarDato"," ");
        ...
        if( resultSet.first() ){
                   ...
                   this.jTFUsuario.setText(resultSet.getString("usuario"));
        ...
        Log.Registrar(this.getClass(), "MostrarDato"," mostro los datos");
  ...
  public void MostrarBotones(boolean b1,boolean b2,boolean b3){
      Log.Registrar(this.getClass(), "MostrarBotones"," "+b1+" "+b2+" "+b3);
   ...
   public void cargarTabla(){
        ...
        String campos = " c.usuario_id,p.rnc,c.id,p.nombre,p.apellido,p.cedula, u.nombre_usuario as usuario,u.tipo_usuario as rol, p.id as personaid,u1.nombre_usuario as creado_por ";
        ...
        resultSet.first();
        String[] titulos = {"ID","USUARIO EMPLEADO","TIPO USUARIO","EMPLEADO","CEDULA","CREADO POR"};
         ...
         int c = 0;
          ...
          do{
                fila[c][0] = resultSet.getString("id");
                    fila[c][1] = resultSet.getString("usuario");
                    fila[c][2] = resultSet.getString("rol");
                    fila[c][3] = resultSet.getString("nombre")+" "+resultSet.getString("apellido"); 
                    fila[c][4] = resultSet.getString("cedula");
          ...
          this.MostrarBotones(true, false, false);
                  Log.Registrar(this.getClass(), "cargarTabla","Se mostro la tabla");
 ...
 Log.Registrar(this.getClass(), "agregarEmail"," ");      
      ...
      Log.Registrar(this.getClass(), "agregarEmail"," se agrego");      
   ...
   public void MostrarBotonesEmail(boolean agregar,boolean editar,boolean cancelar){
      Log.Registrar(this.getClass(), "MostrarBotonesEmail"," "+agregar+" "+editar+" "+cancelar);
   ...
   public void MostrarEmails(){
       Log.Registrar(this.getClass(), "MostrarEmails"," ");
        ...
        this.MostrarBotonesEmail(false, true, true);
               Log.Registrar(this.getClass(), "MostrarEmails","se mostro");
...
Log.Registrar(this.getClass(), "MostrarDatoEmail"," ");
        ...
        this.MostrarBotonesEmail(false, true, true);
        Log.Registrar(this.getClass(), "MostrarDatoEmail","se mostro ");
   ...
   */
     ...
     Log.Registrar(this.getClass(), "agregarDireccion"," ");
        ...
        if(direccion.isEmpty()){
           ...
           try {
              ...
              Log.Registrar(this.getClass(), "agregarDireccion"," se agrego");
            }   catch (SQLException ex) {
                Log.Error(this.getClass().getName(), ex);
                    Logger.getLogger(EmpleadoAdministrar.class.getName()).log(Level.SEVERE, null, ex);
                }
   ...
   public void MostrarBotonesDireccion(boolean agregar,boolean editar,boolean cancelar){
             Log.Registrar(this.getClass(), "MostrarBotonesDireccion"," "+agregar+" "+editar+" "+cancelar);
   ...
   public void MostrarDirecciones(){
     Log.Registrar(this.getClass(), "MostrarDirecciones"," ");
        ...
        try {
            ...
            this.MostrarBotonesDireccion(true, false, false);
                 Log.Registrar(this.getClass(), "MostrarDirecciones"," se mostro");
          } catch (Exception ex) {
              Log.Error(this.getClass().getName(), ex);
            System.out.println(ex.getCause().toString());
          }
    ...
    public void MostrarDatoDireccion(){
        ...
        Log.Registrar(this.getClass(), "MostrarDatoDireccion"," se mostro");
        } catch (Exception ex) {
              Log.Error(this.getClass().getName(), ex);
            System.out.println(ex.getCause().toString());
          }
  ...
  Log.Registrar(this.getClass(), "agregarTelefono"," ");            
        ...
        if(telefono.isEmpty()){
           ...
           try {
               ...
               Log.Registrar(this.getClass(), "agregarTelefono"," se agrego");            
   ...
   public void MostrarBotonesTelefono(boolean agregar,boolean editar,boolean cancelar){
       Log.Registrar(this.getClass(), "MostrarBotonesTelefono"," "+agregar+" "+editar+" "+cancelar);
...
Log.Registrar(this.getClass(), "limpiarTelefono"," ");
   ...
   public void MostrarTelefonos(){
        ...
        try {
            ...
            this.MostrarBotonesTelefono(true, false, false);
                        Log.Registrar(this.getClass(), "MostrarTelefonos"," se mostro");
   ...
   Log.Registrar(this.getClass(), "MostrarDatoTelefono"," ");
        ...
        this.MostrarBotonesTelefono(false, true, true);
           Log.Registrar(this.getClass(), "MostrarDatoTelefono"," se mostro ");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jCBTipoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
