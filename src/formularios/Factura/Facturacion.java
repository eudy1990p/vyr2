...
public class Facturacion extends javax.swing.JFrame {
    ...
    public static Facturacion getInstancia(Mysql mysql){        
        Log.Registrar("Facturacion/generarPDF");
    ...
    public void limpiarProductoTexto(){                 
        ...
        */
        ...
        Log.Registrar("Facturacion/LimpiarProductoTexto se limpiaron los campos del producto");
    }
    ...
    public void optenerReparacionesPendienteFacturarDelCliente(){        
        ...
        try {
            ...
            Log.Error("optenerReparacionesPendienteFacturarDelCliente", ex);
     ...
     public void optenerCotizacionPendienteFacturarDelCliente(){       
        ...
        try {
            ...
            Log.Error("optenerCotizacionPendienteFacturarDelCliente", ex);
            Logger.getLogger(ListadoProducto.class.getName()).log(Level.SEVERE, null, ex);
        } 
     ...
     public void cargarTablaParaFacturar(String id,String accion){       
        ...
        try {
           ...
           Log.Registrar(this.getClass(), "cargarTablaParaFacturar", "se mostro el "+accion);
        } catch (SQLException ex) {
            Log.Error("cargarTablaParaFacturar", ex);
            Logger.getLogger(ListadoProducto.class.getName()).log(Level.SEVERE, null, ex);
        }  
        this.cargarJTable();
     }
    public void optenerDeudasPendienteFacturarDelCliente(){         
        ...
        try {
            ...
            Log.Error("optenerDeudasPendienteFacturarDelCliente", ex);
            Logger.getLogger(ListadoProducto.class.getName()).log(Level.SEVERE, null, ex);
        } 
    ...
    public void getNCF(){
                Log.Registrar(this.getClass(), "getNCF", "");
        ...
        Log.Registrar(this.getClass(), "getNCF", "tieneNCF "+tieneNCF+" this.NCF "+this.NCF);
    }
    ...
    public void crearFacturacion(){         
        Log.Registrar(this.getClass(), "crearFacturacion", "");
           ...
           this.generarPDF();
           this.ini();
           Log.Registrar(this.getClass(), "crearFacturacion", "Se creo la factura");
    }
        ...
        Log.Registrar(this.getClass(), "reCalcular", "");
           ...
           int lineas = this.nombre_producto.size();
            ...
            for(int c = 0 ; c < lineas ; c++){
             ...
             this.totales(monto);
         Log.Registrar(this.getClass(), "reCalcular", "Se recalculo");
    }
    public void asignarAArrayList(){        
        ...
        try{
            ...
            this.totales(monto);
            Log.Registrar("Producto agregar en los list el producto");
            Log.Registrar("ID "+this.productoID+" CANTIDAD "+this.c_producto+" PRECIO "+this.n_producto
                    +" CODIGO "+this.co_producto+" MONTO "+monto+" SUB TOTAL "+monto+" ");

        }catch(Exception e){
            Log.Error("Facturacion/AsignarAArrayList", e);
        }
    }
    public void agregarTabla(){                
        ...
        try{
            ...
            if(r){
                ...
                this.cargarJTable();
                this.limpiarProductoTexto();
                Log.Registrar(this.getClass(), "agregarTabla", "Se agrego un producto nuevo");
            }
        }catch(Exception e){
            Log.Error("Facturacion/AgregarProducto", e);
        }
    }
    public void validarAgregarEntradaProducto(){        
        ...
        Texto.placeholder(Texto.cantidad_producto,this.t_cantidad_producto.getText(), this.t_cantidad_producto);
         ...
         Log.Error("Facturacion/ValidarAgregarEntradaProducto", e);
       }
    }
    ...
    public void resetTotatel(){       
        ...
        Log.Registrar(this.getClass(), "resetTotatel", " reinicia a cero los totales");
    ...
    public void cargarJTable(){        
        ...
        try {
          ...
          Log.Registrar("Facturacion/cargarJTable se mostrara la tabla con los productos");
        } catch (Exception e) {
          Log.Error("Facturacion/cargarJTable", e);
    ...
    public void generarPDF(){     
        ...
        try {
            ...
            jv.setVisible(true);
            Log.Registrar(this.getClass(), "generarPDF", "Se mostro la jasperViewer");
        } catch (JRException ex) {
            Log.Error("generarPDF", ex);
    ...
    public void administrar_focus_clientes(String menu,String tabla){
        ...
        Log.Registrar("Facturacion/administrar_focus_clientes Abrir lista por "+menu);
        }catch(Exception e){
            Log.Error("Facturacion/administrar_focus_clientes ", e);
        }
    }
    ...
    public void ini(){                
        ...
        this.deuda = false;
        this.cotizado = false;
        Log.Registrar(this.getClass(), "ini", "reinicio la factura");
    }
    ...
    private void initComponents() {
        ...
        JPListas.setBackground(new java.awt.Color(255, 255, 255));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("RELACIONADOS AL CLIENTE SELECCIONADO");
        ...
        jTReparacion.setGridColor(new java.awt.Color(3, 1, 16));
        ...
        jTCotizacion.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jTDeuda.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        javax.swing.GroupLayout JPListasLayout = new javax.swing.GroupLayout(JPListas);
        JPListas.setLayout(JPListasLayout);
        JPListasLayout.setHorizontalGroup(
            JPListasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(JPListasLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(jTabbedPane1)
        );
        JPListasLayout.setVerticalGroup(
            JPListasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(JPListasLayout.createSequentialGroup()
        ...
        jButton4.setBackground(new java.awt.Color(239, 255, 0));
        ...
        JPGeneralLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JPGeneralLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(JPOpciones, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
        JPGeneralLayout.setVerticalGroup(
            ...
            .addGroup(JPGeneralLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(JPOpciones, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        FondoLayout.setHorizontalGroup(
            ...
            .addGroup(FondoLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(JPListas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(9, 9, 9)
        ...
        FondoLayout.setVerticalGroup(
            ...
            .addGroup(FondoLayout.createSequentialGroup()
                ...
                .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(JPTotales, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(JPListas, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(JPGeneral, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        ...
        Log.Registrar(this.getClass(), "jButton4MouseClicked", "Mostrar pago");
    ...
    private void JCBTieneITBISStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_JCBTieneITBISStateChanged
       ...
       Log.Registrar(this.getClass(), "JCBTieneITBISStateChanged", "tiene "+this.tiene_itbis);
    ...
    private void jTextArea1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextArea1KeyReleased
        // TODO add your handling code here:
         ...
         //Log.Registrar(this.getClass(), "", "E");
    }//GEN-LAST:event_jTextArea1KeyReleased

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // TODO add your handling code here:
        instancia = null;
        Log.Registrar(this.getClass(), "formWindowClosed", "Cerrar");
 ...
 public void eliminarItem(){        
     Log.Registrar(this.getClass(), "eliminarItem", "");
        ...
        this.cargarJTable();
        Log.Registrar(this.getClass(), "eliminarItem", "Elminar item");
    }
    /**
